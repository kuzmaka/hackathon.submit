# Coddee Break Team submission for Koding Global Virtual Hackathon

## Description

[![Koding Hackathon](/images/badge.png?raw=true "Koding Hackathon")](https://koding.com/Hackathon)

We developed CODDEE game and its goal is to introduce programming to a begginer in a fun way. We know lessons in a school can be boring. To overcome this drawback of usual lessons we wished to make simple programming to become a part of the game with attention to the game process itself. Thus giving ability to people to get acquainted with programmer way of thinking in an unobtrusive way. So, with CODDEE you can program your garbage collector robot, run it in your own world or play with other CODDEEs in a multiplayer mode. Change the worlds to better and have fun!
